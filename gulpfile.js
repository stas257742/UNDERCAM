...
gulp.task('sass', function(done) { //SASS В Т.Ч С ПОЯВЛЕНЕМ ОШИБКИ 
    gulp.src('app/sass/**/*.sass')
        .pipe(sass().on('error', function(error) {
            ...
            return gulp.src('app/*.html') // 'Эта и строчка ниже нужна для того, что бы при сохранении файла .sass - сохранялся и .html, и изменения сразу вступали в силу на экране
...
gulp.task('watch1', gulp.parallel('sass', 'code', 'watch', 'browser-sync'))
